...
CREATE TABLE `category_task` (
  ...
  KEY `fk_category_task_task_idx` (`task_id`),
  KEY `fk_category_task_category_idx` (`category_id`),
  CONSTRAINT `fk_category_task_category` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_category_task_task` FOREIGN KEY (`task_id`) REFERENCES `task` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-10-04 16:24:55
